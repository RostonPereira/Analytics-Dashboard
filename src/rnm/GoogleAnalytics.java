...
public class GoogleAnalytics {
	...
	private static final String KEY_FILE_LOCATION = "/RNM Dashboard-b83c15b7497a.p12";
	private static final String SERVICE_ACCOUNT_EMAIL = "754766637196-k8dqpgi57s4cjfv5e5hcfv47in7oi2vb@developer.gserviceaccount.com";
	...
	private static String getFirstProfileId(Analytics analytics) throws IOException {
		...
		if (accounts.getItems().isEmpty()) {
			...
			System.out.println(accounts.getItems().get(0).getId());
			System.out.flush();
	...
	private static GaData getResults(Analytics analytics, String profileId) throws IOException {
		...
		return analytics.data().ga().get("ga:" + profileId, "2015-08-14", "2015-08-18", "ga:sessions").execute();
